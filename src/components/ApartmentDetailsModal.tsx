...
export default function ApartmentDetailsModal({ modalRef, closeModal, apartment }: Props) {
    ...
    return (
        <dialog ref={modalRef} className="group open:opacity-100 open:pointer-events-auto opacity-0 pointer-events-none transition-[opacity] duration-300 z-[999] w-full h-dvh flex items-center justify-center bg-black/50">
            <div className="p-10 w-full max-h-full overflow-y-auto overflow-x-hidden">
                <div className="mx-auto group-open:translate-y-0 -translate-y-10 transition-transform duration-300 py-6 w-full max-w-[800px] rounded-xl bg-white border border-gray-200 shadow-lg shadow-black/10">
